  ...
  const fetchPageContent = async () => {
    try {
      ...
      if (data) {
        ...
        const parsedFaqs = data.faqs ? (data.faqs as any[] as FAQItem[]) : getDefaultFAQs();
        const parsedSteps = data.preparation_steps ? (data.preparation_steps as any[] as PreparationStep[]) : getDefaultPreparationSteps();
